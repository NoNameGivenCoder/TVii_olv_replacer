...
**/
WUPS_PLUGIN_NAME("Notifications Plugin");
WUPS_PLUGIN_DESCRIPTION("Simple hello world test.");
WUPS_PLUGIN_VERSION("v1.0");
WUPS_PLUGIN_AUTHOR("NoNameGiven (Maschell)");
...
WUPS_USE_STORAGE("notifications_test"); // Unique id for the storage api
